...
namespace DemosCommonCode.Imaging
{
    ...
    public partial class ActionProgressForm : Form
    {
        ...
        private class ActionProgressHandler : IActionProgressHandler
        {
                ...
                bool canCancel)
            {
                ...
                if (logMessage != null)
                {
                    ...
                    {
                        logMessage = string.Format(SpreadsheetEditorDemo.Localization.Strings.DEMOSCOMMONCODE_IMAGING__FINISHED_ARG0, logMessage);
                    }
                    else
                    {
                        logMessage = "";
        ...
        public ActionProgressForm(DoBackgroundWorkDelegate callback, int levelCount, string caption)
        {
            ...
            buttonCancel.Text = SpreadsheetEditorDemo.Localization.Strings.DEMOSCOMMONCODE_IMAGING_CANCEL;
            ...
            RunWorkerCompletedEventArgs e)
        {
            ...
            if (e.Error != null)
            {
                ...
                text = SpreadsheetEditorDemo.Localization.Strings.DEMOSCOMMONCODE_IMAGING_ERROR;
            }
            else
            {
                ...
                if (_progressController.IsCanceled)
                    text = SpreadsheetEditorDemo.Localization.Strings.DEMOSCOMMONCODE_IMAGING_CANCELED;
                else
                    text = SpreadsheetEditorDemo.Localization.Strings.DEMOSCOMMONCODE_IMAGING_FINISHED;
            }
            _buttonCancel.Text = SpreadsheetEditorDemo.Localization.Strings.DEMOSCOMMONCODE_IMAGING_CLOSE;
        ...
        private DialogResult GetActionDialogResult()
        {
            ...
            _logText.AppendText(SpreadsheetEditorDemo.Localization.Strings.DEMOSCOMMONCODE_IMAGING_CANCELED_ALT1);
