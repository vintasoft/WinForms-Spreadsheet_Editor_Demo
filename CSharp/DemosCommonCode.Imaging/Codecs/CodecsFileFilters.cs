...
namespace CommonCode.Imaging.Codecs
{
    ...
    public class CodecsFileFilters
    {
        ...
        static void InitImageDecoderFilter()
        {
            ...
            if (AvailableDecoders.IsDecoderAvailable(SpreadsheetEditorDemo.Localization.Strings.COMMONCODE_IMAGING_CODECS_PPTX))
            {
            ...
            if (AvailableDecoders.IsDecoderAvailable(SpreadsheetEditorDemo.Localization.Strings.COMMONCODE_IMAGING_CODECS_CAD))
            {
